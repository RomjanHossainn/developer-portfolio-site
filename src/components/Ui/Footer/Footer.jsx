...
const Footer = () => {
    return (
      <footer className="footer text-white space-y-8 footer-center p-10 bg-base-200 text-base-content rounded">
        ...
        <aside className="text-center flex items-center gap-2 justify-center">
          <p>Copyright © 2023 - Developer Romjan Hossain Ornob</p>
          <BsEmojiSmileUpsideDown className="text-green-500 text-lg" />
        </aside>
      </footer>
    );
};
